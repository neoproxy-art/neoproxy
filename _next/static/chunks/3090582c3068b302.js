(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,305285,e=>{"use strict";var r=e.i(47662);e.i(351894),e.i(813871),e.i(265167),e.i(933781),e.i(970619),e.i(620928);let a="samplerFragmentAlternateDeclaration",i=`#ifdef _DEFINENAME_
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i);let n="pbrFragmentSamplersDeclaration",f=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.i(204560),e.i(160334),e.i(847193),e.i(956235),e.i(864500),e.i(690617),e.i(902241),e.i(11623),e.i(627662),e.i(970070),e.i(285633),e.i(421743),e.i(326857),e.i(945595),e.i(136730),e.i(840951),e.i(48424),e.i(158420),e.i(351357),e.i(379799),e.i(849637);let o="pbrBlockAlbedoOpacity",t=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;r.ShaderStore.IncludesShadersStoreWGSL[o]||(r.ShaderStore.IncludesShadersStoreWGSL[o]=t);let c="pbrBlockReflectivity",l=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;r.ShaderStore.IncludesShadersStoreWGSL[c]||(r.ShaderStore.IncludesShadersStoreWGSL[c]=l);let d="pbrBlockAmbientOcclusion",s=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;r.ShaderStore.IncludesShadersStoreWGSL[d]||(r.ShaderStore.IncludesShadersStoreWGSL[d]=s);let E="pbrBlockAlphaFresnel",S=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[E]||(r.ShaderStore.IncludesShadersStoreWGSL[E]=S);let R="pbrBlockAnisotropic",m=`#ifdef ANISOTROPIC
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[R]||(r.ShaderStore.IncludesShadersStoreWGSL[R]=m);let C="pbrBlockReflection",u=`#ifdef REFLECTION
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[C]||(r.ShaderStore.IncludesShadersStoreWGSL[C]=u);let v="pbrBlockSheen",p=`#ifdef SHEEN
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[v]||(r.ShaderStore.IncludesShadersStoreWGSL[v]=p);let A="pbrBlockClearcoat",I=`struct clearcoatOutParams
...
return outParams;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[A]||(r.ShaderStore.IncludesShadersStoreWGSL[A]=I);let N="pbrBlockIridescence",O=`struct iridescenceOutParams
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[N]||(r.ShaderStore.IncludesShadersStoreWGSL[N]=O);let T="pbrBlockSubSurface",L=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[T]||(r.ShaderStore.IncludesShadersStoreWGSL[T]=L),e.i(983784),e.i(372596),e.i(876632);let _="pbrBlockNormalFinal",M=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[_]||(r.ShaderStore.IncludesShadersStoreWGSL[_]=M),e.i(116507);let F="pbrBlockLightmapInit",h=`#ifdef LIGHTMAP
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[F]||(r.ShaderStore.IncludesShadersStoreWGSL[F]=h);let D="pbrBlockGeometryInfo",g=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[D]||(r.ShaderStore.IncludesShadersStoreWGSL[D]=g),e.i(566364);let P="pbrBlockReflectance",U=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[P]||(r.ShaderStore.IncludesShadersStoreWGSL[P]=U);let b="pbrBlockDirectLighting",y=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[b]||(r.ShaderStore.IncludesShadersStoreWGSL[b]=y),e.i(920385);let B="pbrBlockFinalLitComponents",G=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[B]||(r.ShaderStore.IncludesShadersStoreWGSL[B]=G);let V="pbrBlockFinalUnlitComponents",x=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;r.ShaderStore.IncludesShadersStoreWGSL[V]||(r.ShaderStore.IncludesShadersStoreWGSL[V]=x);let H="pbrBlockFinalColorComposition",W=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;r.ShaderStore.IncludesShadersStoreWGSL[H]||(r.ShaderStore.IncludesShadersStoreWGSL[H]=W),e.i(282742),e.i(775587),e.i(88558),e.i(86826),e.i(170177),e.i(291032);let Y="pbrPixelShader",k=`#define PBR_FRAGMENT_SHADER
...
`;r.ShaderStore.ShadersStoreWGSL[Y]||(r.ShaderStore.ShadersStoreWGSL[Y]=k),e.s(["pbrPixelShaderWGSL",0,{name:Y,shader:k}],305285)}]);