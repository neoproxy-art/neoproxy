(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,920385,e=>{"use strict";var t=e.i(47662);let r="lightFragment",o=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s(["lightFragmentWGSL",0,{name:r,shader:o}])},898135,e=>{"use strict";var t=e.i(47662);let r="clusteredLightingFunctions",o=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
...
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([])},197412,e=>{"use strict";var t=e.i(47662);let r="ltcHelperFunctions",o=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([])},956235,e=>{"use strict";var t=e.i(47662);let r="fogFragmentDeclaration",o=`#ifdef FOG
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s(["fogFragmentDeclarationWGSL",0,{name:r,shader:o}])},775587,e=>{"use strict";var t=e.i(47662);let r="fogFragment",o=`#ifdef FOG
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([])},160334,e=>{"use strict";var t=e.i(47662);let r="clipPlaneFragmentDeclaration",o=`#ifdef CLIPPLANE
...
{discard;}
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s(["clipPlaneFragmentWGSL",0,{name:r,shader:o}])},282742,e=>{"use strict";var t=e.i(47662);let r="logDepthFragment",o=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([])},204560,e=>{"use strict";var t=e.i(47662);let r="imageProcessingDeclaration",o=`#ifdef EXPOSURE
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s(["imageProcessingDeclarationWGSL",0,{name:r,shader:o}])},627662,e=>{"use strict";var t=e.i(47662);let r="imageProcessingFunctions",o=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s(["imageProcessingFunctionsWGSL",0,{name:r,shader:o}])},970070,e=>{"use strict";var t=e.i(47662);let r="shadowsFragmentFunctions",o=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s(["shadowsFragmentFunctionsWGSL",0,{name:r,shader:o}])},970619,e=>{"use strict";var t=e.i(47662);let r="lightUboDeclaration",o=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s(["lightUboDeclarationWGSL",0,{name:r,shader:o}])},379799,e=>{"use strict";var t=e.i(47662);let r="reflectionFunction",o=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s(["reflectionFunctionWGSL",0,{name:r,shader:o}])}]);