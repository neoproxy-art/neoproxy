(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,105587,e=>{"use strict";var r=e.i(47662);let n="textureMergerPixelShader",t=`#ifdef USE_TEXTURE0
...
#endif
fragmentOutputs.color=vec4f(r,g,b,a);}`;r.ShaderStore.ShadersStoreWGSL[n]||(r.ShaderStore.ShadersStoreWGSL[n]=t),e.s(["textureMergerPixelShaderWGSL",0,{name:n,shader:t}])}]);