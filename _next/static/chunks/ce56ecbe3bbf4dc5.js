(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,291527,e=>{"use strict";var t=e.i(47662);let o="selectionOutlinePixelShader",s=`uniform sampler2D maskSampler;uniform sampler2D depthSampler;varying vec2 vUV;uniform vec2 screenSize;uniform vec3 outlineColor;uniform float outlineThickness;uniform float occlusionStrength;uniform float occlusionThreshold;
...
`;t.ShaderStore.ShadersStore[o]||(t.ShaderStore.ShadersStore[o]=s),e.s(["selectionOutlinePixelShader",0,{name:o,shader:s}])}]);