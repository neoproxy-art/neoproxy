(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,356046,e=>{"use strict";var r=e.i(47662);e.i(351894),e.i(813871),e.i(360777),e.i(933781),e.i(970619),e.i(620928);let i="openpbrFragmentSamplersDeclaration",a=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[i]||(r.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.i(204560),e.i(160334),e.i(847193),e.i(956235),e.i(864500),e.i(690617),e.i(902241),e.i(11623),e.i(627662),e.i(970070),e.i(285633),e.i(421743),e.i(326857),e.i(945595),e.i(136730),e.i(840951),e.i(48424);let n="openpbrNormalMapFragmentMainFunctions",o=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=o);let t="openpbrNormalMapFragmentFunctions",f=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=f),e.i(379799);let s="openpbrDielectricReflectance",l=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;r.ShaderStore.IncludesShadersStoreWGSL[s]||(r.ShaderStore.IncludesShadersStoreWGSL[s]=l);let c="openpbrConductorReflectance",m=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;r.ShaderStore.IncludesShadersStoreWGSL[c]||(r.ShaderStore.IncludesShadersStoreWGSL[c]=m);let d="openpbrAmbientOcclusionFunctions",_=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;r.ShaderStore.IncludesShadersStoreWGSL[d]||(r.ShaderStore.IncludesShadersStoreWGSL[d]=_);let u="openpbrGeometryInfo",p=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;r.ShaderStore.IncludesShadersStoreWGSL[u]||(r.ShaderStore.IncludesShadersStoreWGSL[u]=p);let g="openpbrIblFunctions",v=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[g]||(r.ShaderStore.IncludesShadersStoreWGSL[g]=v),e.i(983784),e.i(372596);let S="openpbrNormalMapFragment",I=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[S]||(r.ShaderStore.IncludesShadersStoreWGSL[S]=I);let E="openpbrBlockNormalFinal",h=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[E]||(r.ShaderStore.IncludesShadersStoreWGSL[E]=h);let R="openpbrBaseLayerData",N=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[A]||(r.ShaderStore.IncludesShadersStoreWGSL[A]=T);let L="openpbrCoatLayerData",b=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[L]||(r.ShaderStore.IncludesShadersStoreWGSL[L]=b);let F="openpbrThinFilmLayerData",O=`#ifdef THIN_FILM
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[F]||(r.ShaderStore.IncludesShadersStoreWGSL[F]=O);let C="openpbrFuzzLayerData",D=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[C]||(r.ShaderStore.IncludesShadersStoreWGSL[C]=D);let M="openpbrAmbientOcclusionData",x=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[M]||(r.ShaderStore.IncludesShadersStoreWGSL[M]=x),e.i(116507);let G="openpbrBackgroundTransmission",P=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[G]||(r.ShaderStore.IncludesShadersStoreWGSL[G]=P);let z="openpbrEnvironmentLighting",y=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[z]||(r.ShaderStore.IncludesShadersStoreWGSL[z]=y);let W="openpbrDirectLightingInit",U=`#ifdef LIGHT{X}
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[W]||(r.ShaderStore.IncludesShadersStoreWGSL[W]=U);let X="openpbrDirectLighting",B=`#ifdef LIGHT{X}
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[X]||(r.ShaderStore.IncludesShadersStoreWGSL[X]=B),e.i(282742),e.i(775587),e.i(88558),e.i(86826),e.i(170177),e.i(291032);let V="openpbrPixelShader",H=`#define OPENPBR_FRAGMENT_SHADER
...
`;r.ShaderStore.ShadersStoreWGSL[V]||(r.ShaderStore.ShadersStoreWGSL[V]=H),e.s(["openpbrPixelShaderWGSL",0,{name:V,shader:H}],356046)}]);