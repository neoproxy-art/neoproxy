(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,852954,e=>{"use strict";var n=e.i(47662);let r="textureMergerPixelShader",t=`#ifdef USE_TEXTURE0
...
#endif
gl_FragColor=vec4(r,g,b,a);}`;n.ShaderStore.ShadersStore[r]||(n.ShaderStore.ShadersStore[r]=t),e.s(["textureMergerPixelShader",0,{name:r,shader:t}])}]);