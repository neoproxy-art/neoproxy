(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,322101,e=>{"use strict";var t=e.i(47662);e.i(360896),e.i(980239);let i="volumetricLightingRenderVolumePixelShader",r=`#include<sceneUboDeclaration>
...
`;t.ShaderStore.ShadersStoreWGSL[i]||(t.ShaderStore.ShadersStoreWGSL[i]=r),e.s(["volumetricLightingRenderVolumePixelShaderWGSL",0,{name:i,shader:r}])}]);