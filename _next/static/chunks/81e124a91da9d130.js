...
`;i.ShaderStore.IncludesShadersStore[n]||(i.ShaderStore.IncludesShadersStore[n]=a),e.i(812159),e.i(170562),e.i(482656),e.i(331116),e.i(530550);let r="samplerFragmentAlternateDeclaration",f=`#ifdef _DEFINENAME_
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=f);let o="pbrFragmentSamplersDeclaration",t=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.i(857325),e.i(981239),e.i(245224),e.i(971154),e.i(87714),e.i(927068),e.i(928993),e.i(601010),e.i(377772),e.i(67654),e.i(230514),e.i(249579),e.i(395368),e.i(707199),e.i(833879),e.i(478167),e.i(999434),e.i(537187),e.i(200610),e.i(835716),e.i(175222);let c="pbrBlockAlbedoOpacity",l=`struct albedoOpacityOutParams
...
`;i.ShaderStore.IncludesShadersStore[c]||(i.ShaderStore.IncludesShadersStore[c]=l);let d="pbrBlockReflectivity",s=`struct reflectivityOutParams
...
`;i.ShaderStore.IncludesShadersStore[d]||(i.ShaderStore.IncludesShadersStore[d]=s);let E="pbrBlockAmbientOcclusion",R=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;i.ShaderStore.IncludesShadersStore[E]||(i.ShaderStore.IncludesShadersStore[E]=R);let C="pbrBlockAlphaFresnel",S=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[C]||(i.ShaderStore.IncludesShadersStore[C]=S);let u="pbrBlockAnisotropic",A=`#ifdef ANISOTROPIC
...
#endif
`;i.ShaderStore.IncludesShadersStore[u]||(i.ShaderStore.IncludesShadersStore[u]=A);let m="pbrBlockReflection",I=`#ifdef REFLECTION
...
#endif
`;i.ShaderStore.IncludesShadersStore[m]||(i.ShaderStore.IncludesShadersStore[m]=I);let v="pbrBlockSheen",N=`#ifdef SHEEN
...
#endif
`;i.ShaderStore.IncludesShadersStore[v]||(i.ShaderStore.IncludesShadersStore[v]=N);let T="pbrBlockClearcoat",O=`struct clearcoatOutParams
...
return outParams;}
#endif
`;i.ShaderStore.IncludesShadersStore[T]||(i.ShaderStore.IncludesShadersStore[T]=O);let p="pbrBlockIridescence",L=`struct iridescenceOutParams
...
#endif
`;i.ShaderStore.IncludesShadersStore[p]||(i.ShaderStore.IncludesShadersStore[p]=L);let _="pbrBlockSubSurface",M=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;i.ShaderStore.IncludesShadersStore[_]||(i.ShaderStore.IncludesShadersStore[_]=M),e.i(595208);let h="pbrBlockReflectance0",D=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;i.ShaderStore.IncludesShadersStore[h]||(i.ShaderStore.IncludesShadersStore[h]=D);let F="pbrClusteredLightingFunctions",g=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;i.ShaderStore.IncludesShadersStore[F]||(i.ShaderStore.IncludesShadersStore[F]=g),e.i(179939),e.i(325472),e.i(787126);let P="pbrBlockNormalFinal",U=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[P]||(i.ShaderStore.IncludesShadersStore[P]=U),e.i(979795);let b="pbrBlockLightmapInit",y=`#ifdef LIGHTMAP
...
#endif
`;i.ShaderStore.IncludesShadersStore[b]||(i.ShaderStore.IncludesShadersStore[b]=y);let B="pbrBlockGeometryInfo",G=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[B]||(i.ShaderStore.IncludesShadersStore[B]=G);let V="pbrBlockReflectance",H=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[V]||(i.ShaderStore.IncludesShadersStore[V]=H);let x="pbrBlockDirectLighting",W=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;i.ShaderStore.IncludesShadersStore[x]||(i.ShaderStore.IncludesShadersStore[x]=W),e.i(960096);let Y="pbrBlockFinalLitComponents",k=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[Y]||(i.ShaderStore.IncludesShadersStore[Y]=k);let X="pbrBlockFinalUnlitComponents",w=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;i.ShaderStore.IncludesShadersStore[X]||(i.ShaderStore.IncludesShadersStore[X]=w);let K="pbrBlockFinalColorComposition",z=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;i.ShaderStore.IncludesShadersStore[K]||(i.ShaderStore.IncludesShadersStore[K]=z),e.i(349426),e.i(372079),e.i(586272),e.i(728767),e.i(556015),e.i(460382);let Z="pbrPixelShader",q=`#define PBR_FRAGMENT_SHADER
...
`;i.ShaderStore.ShadersStore[Z]||(i.ShaderStore.ShadersStore[Z]=q),e.s(["pbrPixelShader",0,{name:Z,shader:q}],48721)}]);