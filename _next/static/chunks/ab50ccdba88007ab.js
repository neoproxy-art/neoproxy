(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,755878,e=>{"use strict";var t=e.i(47662);let l="selectionOutlinePixelShader",o=`var maskSamplerSampler: sampler;var maskSampler: texture_2d<f32>;var depthSamplerSampler: sampler;var depthSampler: texture_2d<f32>;varying vUV: vec2f;uniform screenSize: vec2f;uniform outlineColor: vec3f;uniform outlineThickness: f32;uniform occlusionStrength: f32;uniform occlusionThreshold: f32;
...
`;t.ShaderStore.ShadersStoreWGSL[l]||(t.ShaderStore.ShadersStoreWGSL[l]=o),e.s(["selectionOutlinePixelShaderWGSL",0,{name:l,shader:o}])}]);