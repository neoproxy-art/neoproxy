(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,945595,e=>{"use strict";var t=e.i(47662);let f="pbrBRDFFunctions",i=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;t.ShaderStore.IncludesShadersStoreWGSL[f]||(t.ShaderStore.IncludesShadersStoreWGSL[f]=i),e.s([],902241);let r="hdrFilteringFunctions",a=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([],136730)},933781,690617,11623,421743,326857,566364,840951,48424,372596,88558,86826,291032,e=>{"use strict";var t=e.i(47662);e.i(272033);let f="pbrFragmentExtraDeclaration",i=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[f]||(t.ShaderStore.IncludesShadersStoreWGSL[f]=i),e.s([],933781);let r="subSurfaceScatteringFunctions",a=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([],690617);let n="pbrHelperFunctions",o=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[n]||(t.ShaderStore.IncludesShadersStoreWGSL[n]=o),e.s([],11623),e.i(197412);let c="pbrDirectLightingSetupFunctions",l=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[c]||(t.ShaderStore.IncludesShadersStoreWGSL[c]=l),e.s([],421743);let s="pbrDirectLightingFalloffFunctions",d=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;t.ShaderStore.IncludesShadersStoreWGSL[s]||(t.ShaderStore.IncludesShadersStoreWGSL[s]=d),e.s([],326857),e.i(898135);let u="pbrBlockReflectance0",v=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[u]||(t.ShaderStore.IncludesShadersStoreWGSL[u]=v),e.s([],566364);let h="pbrDirectLightingFunctions",p=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SS_TRANSLUCENCY
...
return result;}
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[h]||(t.ShaderStore.IncludesShadersStoreWGSL[h]=p),e.s([],840951);let E="pbrIBLFunctions",g=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[E]||(t.ShaderStore.IncludesShadersStoreWGSL[E]=g),e.s([],48424);let m="pbrBlockNormalGeometric",L=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[m]||(t.ShaderStore.IncludesShadersStoreWGSL[m]=L),e.s([],372596);let S="pbrBlockImageProcessing",R=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[S]||(t.ShaderStore.IncludesShadersStoreWGSL[S]=R),e.s([],88558);let N="pbrBlockPrePass",D=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[N]||(t.ShaderStore.IncludesShadersStoreWGSL[N]=D),e.s([],86826);let A="pbrDebug",I=`#if DEBUGMODE>0
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[A]||(t.ShaderStore.IncludesShadersStoreWGSL[A]=I),e.s([],291032)}]);